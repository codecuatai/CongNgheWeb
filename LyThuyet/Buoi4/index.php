        ...
        <table class="table" style="border: solid 1px black">
            ...
            <tbody>
                <?php if (!empty($do_an_list)): ?>
                    ...
                    <?php foreach ($do_an_list as $data): ?>
                        <tr>
                            <td><?php echo $data['id'] ?></td>
                            <td><?php echo $data['ten_de_tai'] ?></td>
                            <td><?php echo $data['ten_sinh_vien'] . ' - ' . $data['mssv']; ?></td>
                            <td><?php echo $data['giang_vien_hd'] ?></td>
                            <td><?php echo $data['nam_hoc'] ?></td>
